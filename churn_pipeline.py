...
def do_modelling(log_pth, doc_pth, x_train, x_test, y_train, y_test):
    '''
    Method that does the modelling
    '''
    churn_modelling_step = cmod.ChurnModelling(log_pth, doc_pth)
...
if __name__ == '__main__':
    ...
    do_modelling(LOG_PTH, DOC_PTH, X_TRAIN, X_TEST, Y_TRAIN, Y_TEST)
